    ...
    <div id="middle">
        <div class="inputs">
            <div class="input_name">Continent*
                <img src='/aiddata/imgs/meta_info.jpg' class='info' title='input continent'>
                <img src='/aiddata/imgs/meta_note.jpg' class='info' title='case sensitive. must be a valid (existing) continent'>
            </div> 
            <input type="text" id="raster_continent" name="raster_continent" class="required" value=""><br> 
            
            <div class="input_name">Country*
                <img src='/aiddata/imgs/meta_info.jpg' class='info' title='input country'>
                <img src='/aiddata/imgs/meta_note.jpg' class='info' title='case sensitive. must be a valid (existing) country'>
            </div> 
